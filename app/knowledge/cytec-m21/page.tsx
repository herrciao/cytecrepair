...
export default function M21KnowledgeHubPage() {
  ...
  const symptomCards = [
    ...
    {
      title: 'Spindle Face Oil Leak',
      description: 'Oil traces on the spindle face — identify whether it\'s hydraulic oil, coolant, or cutting fluid, and pinpoint the leak source.',
      href: '/knowledge/cytec-m21/spindle-face-oil-leak',
      icon: (
        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
